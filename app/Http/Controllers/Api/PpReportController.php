...
use App\Http\Resources\Api\PpReportAdmin as PpReportResource;
...
class PpReportController extends Controller
{
    ...
    {
        return PpReportResource::collection(PpReport::all());
    }
    ...
    {
        return new PpReportResource(PpReport::find($id));
    }
